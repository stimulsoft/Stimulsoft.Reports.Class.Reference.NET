---
title: "StiStackedColumnSeriesCoreXF3D Class"
---

## StiStackedColumnSeriesCoreXF3D Class
...
**StiStackedColumnSeriesCoreXF3D**(**series**: IStiSeries)
...
**RenderSeries3D**(**render3D**: [StiRender3D](StiRender3D.md), **context**: [StiContext](../Stimulsoft/Base/Context/StiContext.md), **rect**: [StiRectangle3D](StiRectangle3D.md), **geom**: [StiAreaGeom](StiAreaGeom.md), **index**: int, ****: IStiSeriesseries): void

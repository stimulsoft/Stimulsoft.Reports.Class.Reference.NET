---
title: "StiTextInCellsV1Builder Class"
---

## StiTextInCellsV1Builder Class

**Namespace:** `Stimulsoft.Report.Engine`

### Inheritance

Inherits from: [StiSimpleTextV1Builder](StiSimpleTextV1Builder.md)  
...
- **outContainer** (StiContainer) — Panel in what rendering will be done.  

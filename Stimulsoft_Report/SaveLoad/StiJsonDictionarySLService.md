---
title: "StiJsonDictionarySLService Class"
---

## StiJsonDictionarySLService Class
...
```csharp
public class StiJsonDictionarySLService
```
...
| **Merge** | void | Merges a dictionary from the stream. |

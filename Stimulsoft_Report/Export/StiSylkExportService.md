---
title: "StiSylkExportService Class"
---
...
**ExportSylk**(**report**: [StiReport](../root/StiReport.md), **fileName**: string): void
...
**ExportSylk**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream): void
...
**ExportSylk**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream, **settings**: StiDataExportSettings): void

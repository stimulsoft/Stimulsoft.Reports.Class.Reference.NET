---
title: "StiCsvExportService Class"
---

## StiCsvExportService Class
...
| **ExportCsv** *(+2 overloads)* | void | Exports a rendered report to a csv file. |
...
**ExportCsv**(**report**: [StiReport](../root/StiReport.md), **fileName**: string): void
...
**ExportCsv**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream): void
...
**ExportCsv**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream, **settings**: StiDataExportSettings): void

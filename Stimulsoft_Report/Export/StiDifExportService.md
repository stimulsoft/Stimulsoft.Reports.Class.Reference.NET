---
title: "StiDifExportService Class"
---

## StiDifExportService Class
...
| --- | --- | --- |
| **Export** | void | Exports a rendered report to a dif file. |
| **ExportDif** *(+2 overloads)* | void | Exports a rendered report to a Dif file. |
...
**ExportDif**(**report**: [StiReport](../root/StiReport.md), **fileName**: string): void
...
**ExportDif**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream): void
...
**ExportDif**(**report**: [StiReport](../root/StiReport.md), **stream**: Stream, **settings**: StiDataExportSettings): void

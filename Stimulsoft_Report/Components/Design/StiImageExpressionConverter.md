---
title: "StiImageExpressionConverter Class"
---

## StiImageExpressionConverter Class

**Namespace:** `Stimulsoft.Report.Components.Design`

Provides a type converter to convert Image Expression to and from various other representations.

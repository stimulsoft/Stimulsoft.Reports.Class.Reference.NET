---
title: "StiImageURLExpression Class"
---

## StiImageURLExpression Class
...
**StiImageURLExpression**(**value**: string)
...
**StiImageURLExpression**(**parent**: StiComponent, **propertyName**: string)

---
title: "StiOracleDatabase Class"
---

## StiOracleDatabase Class
...
**StiOracleDatabase**(**name**: string, **connectionString**: string)
...
**StiOracleDatabase**(**name**: string, **alias**: string, **connectionString**: string)
...
**StiOracleDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool)
...
**StiOracleDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool, **key**: string)

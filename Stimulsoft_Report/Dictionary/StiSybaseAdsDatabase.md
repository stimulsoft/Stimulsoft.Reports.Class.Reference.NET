...
**StiSybaseAdsDatabase**(**name**: string, **connectionString**: string)
...
**StiSybaseAdsDatabase**(**name**: string, **alias**: string, **connectionString**: string)
...
**StiSybaseAdsDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool)
...
**StiSybaseAdsDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool, **key**: string)

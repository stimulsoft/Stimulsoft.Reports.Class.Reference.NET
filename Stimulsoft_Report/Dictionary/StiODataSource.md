...
**StiODataSource**(**nameInSource**: string, **name**: string)
...
**StiODataSource**(**nameInSource**: string, **name**: string, **alias**: string)
...
**StiODataSource**(**nameInSource**: string, **name**: string, **alias**: string, **sqlCommand**: string)

---
title: "StiOdbcDatabase Class"
---

## StiOdbcDatabase Class
...
**StiOdbcDatabase**(**name**: string, **connectionString**: string)
...
**StiOdbcDatabase**(**name**: string, **alias**: string, **connectionString**: string)
...
**StiOdbcDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool)
...
**StiOdbcDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool, **key**: string)

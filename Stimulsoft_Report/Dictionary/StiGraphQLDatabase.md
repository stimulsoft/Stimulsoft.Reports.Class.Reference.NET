...
**StiGraphQLDatabase**(**name**: string, **connectionString**: string)
...
**StiGraphQLDatabase**(**name**: string, **alias**: string, **connectionString**: string)
...
**StiGraphQLDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool)
...
**StiGraphQLDatabase**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool, **key**: string)

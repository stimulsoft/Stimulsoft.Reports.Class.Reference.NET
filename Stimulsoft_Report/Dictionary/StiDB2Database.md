...
**StiDB2Database**(**name**: string, **connectionString**: string)
...
**StiDB2Database**(**name**: string, **alias**: string, **connectionString**: string)
...
**StiDB2Database**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool)
...
**StiDB2Database**(**name**: string, **alias**: string, **connectionString**: string, **promptUserNameAndpassword**: bool, **key**: string)

---
title: "StiCategoryAttribute Class"
---
...
| **Source** | [StiCategorySource](StiCategorySource.md) | Gets or sets the source of the localization keys from which that category should be taken. |

---
title: "StiMsSqlConnector Class"
---

## StiMsSqlConnector Class
...
| --- | --- |
| **StiMsSqlConnector**(string connectionString) |  |

**StiMsSqlConnector**(**connectionString**: string)
...
| **Get** `static` | [StiMsSqlConnector](StiMsSqlConnector.md) |  |
...
**Get**(**connectionString**: string): [StiMsSqlConnector](StiMsSqlConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiMsSqlConnector](StiMsSqlConnector.md)

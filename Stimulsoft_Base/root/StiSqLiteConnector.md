---
title: "StiSqLiteConnector Class"
---

## StiSqLiteConnector Class
...
| --- | --- |
| **StiSqLiteConnector**(string connectionString) |  |

**StiSqLiteConnector**(**connectionString**: string)
...
| **Get** `static` | [StiSqLiteConnector](StiSqLiteConnector.md) |  |
...
**Get**(**connectionString**: string): [StiSqLiteConnector](StiSqLiteConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiSqLiteConnector](StiSqLiteConnector.md)

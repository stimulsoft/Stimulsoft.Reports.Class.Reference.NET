---
title: "StiInformixConnector Class"
---

## StiInformixConnector Class
...
| **Get** `static` | [StiInformixConnector](StiInformixConnector.md) |  |
...
**Get**(**connectionString**: string): [StiInformixConnector](StiInformixConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiInformixConnector](StiInformixConnector.md)
...
#### StiInformixConnector

**StiInformixConnector**(**connectionString**: string): internal

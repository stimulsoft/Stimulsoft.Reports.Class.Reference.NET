...
**StiMongoDbConnector**(**connectionString**: string)
...
**Get**(**connectionString**: string): [StiMongoDbConnector](StiMongoDbConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiMongoDbConnector](StiMongoDbConnector.md)

---
title: "StiVistaDbConnector Class"
---
...
| --- | --- |
| **StiVistaDbConnector**(string connectionString) |  |

**StiVistaDbConnector**(**connectionString**: string)
...
| **Get** `static` | [StiVistaDbConnector](StiVistaDbConnector.md) |  |
...
**Get**(**connectionString**: string): [StiVistaDbConnector](StiVistaDbConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiVistaDbConnector](StiVistaDbConnector.md)

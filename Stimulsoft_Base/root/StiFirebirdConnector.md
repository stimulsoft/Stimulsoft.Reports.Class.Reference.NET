---
title: "StiFirebirdConnector Class"
---

## StiFirebirdConnector Class
...
| --- | --- |
| **StiFirebirdConnector**(string connectionString) |  |

**StiFirebirdConnector**(**connectionString**: string)
...
| **Get** `static` | [StiFirebirdConnector](StiFirebirdConnector.md) |  |
...
**Get**(**connectionString**: string): [StiFirebirdConnector](StiFirebirdConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiFirebirdConnector](StiFirebirdConnector.md)

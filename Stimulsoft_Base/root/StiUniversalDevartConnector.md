---
title: "StiUniversalDevartConnector Class"
---

## StiUniversalDevartConnector Class
...
| --- | --- |
| **StiUniversalDevartConnector**(string connectionString) |  |

**StiUniversalDevartConnector**(**connectionString**: string)
...
| **Get** `static` | [StiUniversalDevartConnector](StiUniversalDevartConnector.md) |  |
...
**Get**(**connectionString**: string): [StiUniversalDevartConnector](StiUniversalDevartConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiUniversalDevartConnector](StiUniversalDevartConnector.md)

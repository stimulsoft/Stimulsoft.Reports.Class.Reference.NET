---
title: "StiTeradataConnector Class"
---

## StiTeradataConnector Class
...
| --- | --- |
| **StiTeradataConnector**(string connectionString) |  |

**StiTeradataConnector**(**connectionString**: string)
...
| **Get** `static` | [StiTeradataConnector](StiTeradataConnector.md) |  |
...
**Get**(**connectionString**: string): [StiTeradataConnector](StiTeradataConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiTeradataConnector](StiTeradataConnector.md)

---
title: "StiSybaseConnector Class"
---

## StiSybaseConnector Class
...
| --- | --- |
| **StiSybaseConnector**(string connectionString) |  |

**StiSybaseConnector**(**connectionString**: string)
...
| **Get** `static` | [StiSybaseConnector](StiSybaseConnector.md) |  |
...
**Get**(**connectionString**: string): [StiSybaseConnector](StiSybaseConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiSybaseConnector](StiSybaseConnector.md)

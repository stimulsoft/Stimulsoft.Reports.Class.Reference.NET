...
**StiSqlCeConnector**(**connectionString**: string)
...
**Get**(**connectionString**: string): [StiSqlCeConnector](StiSqlCeConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiSqlCeConnector](StiSqlCeConnector.md)

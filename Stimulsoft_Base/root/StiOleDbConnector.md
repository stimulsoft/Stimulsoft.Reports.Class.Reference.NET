...
**StiOleDbConnector**(**connectionString**: string)
...
**Get**(**connectionString**: string): [StiOleDbConnector](StiOleDbConnector.md)

**Parameters**

- **connectionString** (string)  

**Returns** [StiOleDbConnector](StiOleDbConnector.md)

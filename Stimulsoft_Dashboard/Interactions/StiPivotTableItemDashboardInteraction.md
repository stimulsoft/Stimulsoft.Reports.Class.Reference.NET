---
title: "StiPivotTableItemDashboardInteraction Class"
---

## StiPivotTableItemDashboardInteraction Class
...
```csharp
public class StiPivotTableItemDashboardInteraction
```
...
| --- | --- |
| **StiPivotTableItemDashboardInteraction**() |  |
